...
BLOB = Struct(
    "width" / Rebuild(Byte, (len_(this.blob) > 254) + 1),
    "length" / IfThenElse(this.width == 1,
            Rebuild(Byte,    len_(this.blob)+1),
            Rebuild(Int16ul, len_(this.blob)+1),
            ),
...
UNODRPT = Struct(
    ...
    Const(b"\x00\x01\x0d"),
    Const(b"\x30\x00"), "line0" / BLOB,
    Const(b"\x31\x00"), "line1" / BLOB,
    Const(b"\x32\x00"), "line2" / BLOB,
    Const(b"\x33\x00"), "line3" / BLOB,
    Const(b"\x34\x00"), "line4" / BLOB,
    Const(b"\x35\x00"), "line5" / BLOB,
    Const(b"\x36\x00"), "line6" / BLOB,
    Const(b"\x37\x00"), "line7" / BLOB,
    Const(b"\x38\x00"), "line8" / BLOB,
    Const(b"\x39\x00"), "line9" / BLOB,
    Const(b"\x31\x30\x00"), "line10" / BLOB,
    Const(b"\x31\x31\x00"), "line11" / BLOB,
    Const(b"\x31\x32\x00"), "line12" / BLOB,
    Const(b"\x00"),
)
